...
public class GameManagerGMQ : MonoBehaviour {

    public GMQqstn[] gmqqstns;
    private static List<GMQqstn> unansweredGMQ;
    ...
    private GMQqstn currentGMQquestion;
    ...
    void Start()
    {
        if (unansweredGMQ == null || unansweredGMQ.Count == 0)
        {
            unansweredGMQ = gmqqstns.ToList<GMQqstn>();
    ...
    {
        int randomGMQIndex = Random.Range(0, unansweredGMQ.Count);
        currentGMQquestion = unansweredGMQ[randomGMQIndex];

        questionText.text = currentGMQquestion.gmqQuestion;

        unansweredGMQ.RemoveAt(randomGMQIndex);
    }

    IEnumerator TransitionToNextQuestion ()
    {
        unansweredGMQ.Remove(currentGMQquestion);
        ...
        {
            SceneManager.LoadScene("GameSceneAMQ");
            _x = 0;
        }
        Debug.Log("_x" + _x);
    }
    ...
    public void UserSelect (int x)
    {
        ...
        int y = currentGMQquestion.rightGMQAnswer;
        Debug.Log(y);

        if (currentGMQquestion.rightGMQAnswer == x - 1)
        {
...

        {
            ...
            {
                case 0:
                    textWrongAnswer.text = "Correct Answer is " + currentGMQquestion.gmqChoice1;
                    break;
                case 1:
                    textWrongAnswer.text = "Correct Answer is " + currentGMQquestion.gmqChoice2;
                    break;
                case 2:
                    textWrongAnswer.text = "Correct Answer is " + currentGMQquestion.gmqChoice3;
                    break;
                case 4:
                    textWrongAnswer.text = "Correct Answer is " + currentGMQquestion.gmqChoice4;
                    break;
            }
    ...
    {
        Choice1.text = currentGMQquestion.gmqChoice1;
    }
        void SetCurrentChoice2()
    {
        Choice2.text = currentGMQquestion.gmqChoice2;
    }
        void SetCurrentChoice3()
    {
        Choice3.text = currentGMQquestion.gmqChoice3;
    }
        void SetCurrentChoice4()
    {
        Choice4.text = currentGMQquestion.gmqChoice4;
    }
}
